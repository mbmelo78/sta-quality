;(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.woocommerce-checkout #billing_first_name').attr("placeholder", "First name *");
        ...
        $('.woocommerce-checkout #billing_company').attr("placeholder", "Company name (optional)");
        ...
        $('.woocommerce-checkout #billing_phone').attr("placeholder", "Phone *"); 
