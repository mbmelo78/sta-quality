...
class lawsight_Admin_Plugins extends lawsight_Admin_Page {

	public function __construct() {

		$this->id = 'pxlart-plugins';
		$this->page_title = esc_html__( 'Install Plugins', 'Lawsight' );
		$this->menu_title = esc_html__( 'Install Plugins', 'Lawsight' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'Lawsight' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'Lawsight' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'Lawsight' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'Lawsight' );
