...
if (!class_exists('lawsight_Main')) { 
    class lawsight_Main extends lawsight_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new lawsight_Main();
            }
...
function Lawsight() {
    return lawsight_Main::getInstance();
}
// Install
Lawsight(); 
