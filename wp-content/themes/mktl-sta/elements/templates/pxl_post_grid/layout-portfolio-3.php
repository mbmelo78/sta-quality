...
$wrap_attrs = [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-portfolio-grid pxl-portfolio-grid-layout3 pxl-portfolio-style2'),
...
if( count($posts) <= 0){
    echo '<div class="pxl-no-post-grid">'.esc_html__( 'No Post Found', 'lawsight' ). '</div>';
    return;
} ?>
    ...
    <?php if ($select_post_by == 'term_selected' && $filter == "true"): ?>
        <div class="pxl-grid-filter <?php echo esc_attr($filter_type) ?> style-1">
            <div class="pxl--filter-inner">
                <!-- <span class="filter-label"><?php echo esc_html__('Filter By :', 'lawsight'); ?></span> -->
