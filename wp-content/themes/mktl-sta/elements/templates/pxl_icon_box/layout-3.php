<div class="pxl-icon-hover-beutyful">
<div class="pxl-icon-box pxl-icon-box3 u-hover--sparkle <?php echo esc_attr($settings['style'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    ...
    <?php if ( $settings['icon_type'] == 'icon' && !empty($settings['pxl_icon']['value']) ) : ?>
        <div class="pxl-item--icon ct-fancybox-icon pxl-mr-32">
