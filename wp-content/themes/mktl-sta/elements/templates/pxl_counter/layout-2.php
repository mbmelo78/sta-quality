...
<div class="pxl-counter pxl-counter2 <?php echo esc_attr($settings['style'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-counter--inner">
        ...
        <div class="pxl-counter--meta">
            ...
            <div class="pxl-counter--title pxl-empty"><?php echo pxl_print_html($settings['title']); ?></div>
            <div class="pxl-counter--subtitle pxl-empty"><?php echo esc_html($settings['sub_title']); ?></div>
