            ...
            $('.pxl-grid').each(function(index, element) { 
                ...
                $grid_scope.on('click', '.pxl-grid-filter .filter-item', function(e) {
                    ...
                    if( $this.closest('.pxl-grid-filter').hasClass('ajax') ){
                        ...
                        lawsight_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                            { action: 'lawsight_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'filter', scrolltop: 0 }
                        );
                    }else{
                ...
                $grid_scope.on('click', '.pxl-grid-pagination .ajax a.page-numbers', function(e) {
                    ...
                    lawsight_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                        { action: 'lawsight_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'pagination', scrolltop: 0, wpnonce: main_data.wpnonce }
                    );
                ...
                $grid_scope.on('click', '.btn-grid-loadmore', function(e) {
                    ...
                    lawsight_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                        { action: 'lawsight_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'loadmore', scrolltop: 0, wpnonce: main_data.wpnonce }
                    );
                });
            });
        }, 300);

        function lawsight_grid_ajax_handler($this, $grid_scope, $grid_isotope, args = {}){
