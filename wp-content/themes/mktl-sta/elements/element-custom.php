<?php 
/* Start Section */
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_controls' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_overlay_color' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_overlay_img' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_divider' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_particles' );
add_action( 'elementor/element/section/section_structure/after_section_end', 'lawsight_add_custom_section_effect_image' );
function lawsight_add_custom_section_controls( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__( 'Lawsight General Settings', 'Lawsight' ),
    ...
    if ( get_post_type( get_the_ID()) === 'pxl-template' && get_post_meta( get_the_ID(), 'template_type', true ) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__( 'Header Type', 'Lawsight' ),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__( 'Select Type', 'Lawsight' ),
                    'sticky'      => esc_html__( 'Header Sticky', 'Lawsight' ),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__( 'Column Fixed', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'Lawsight' ),
                'fixed'   => esc_html__( 'Yes', 'Lawsight' ),
            ),
    ...
    $element->add_control(
        'row_zoom_point',
        [
            'label'   => esc_html__( 'Zoom Point', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'description' => 'Background color displayed on scroll.',
            'options' => array(
                'false'        => esc_html__( 'No', 'Lawsight' ),
                'true'   => esc_html__( 'Yes', 'Lawsight' ),
            ),
            'default'      => 'false',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Overflow', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__( 'Visible', 'Lawsight' ),
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Section Fixed Scroll', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'Lawsight' ),
                'top'        => esc_html__( 'Top', 'Lawsight' ),
                'bottom'   => esc_html__( 'Bottom', 'Lawsight' ),
            ),
            'default'      => 'none', 
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__( 'Parallax Background Image', 'Lawsight' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position', 'Lawsight' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'X Position', 'Lawsight' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Y Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Size', 'Lawsight' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'Lawsight' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Width', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'Lawsight' ),
            'label_on' => esc_html__( 'Custom', 'Lawsight' ),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ] 
    ...
    $element->start_popover();
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left', 'Lawsight' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top', 'Lawsight' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Right', 'Lawsight' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom', 'Lawsight' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Effect', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'Lawsight' ),
            'label_on' => esc_html__( 'Custom', 'Lawsight' ),
            'return_value' => 'yes',
    ...
    $element->start_popover();
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateX', 'Lawsight' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateY', 'Lawsight' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateZ', 'Lawsight' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'Lawsight' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'Lawsight' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'Lawsight' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'Lawsight' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'Lawsight' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Z', 'Lawsight' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale', 'Lawsight' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scroll From (px)', 'Lawsight' ).' (350) from offset top',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__( 'Parallax Opacity (0 - 100)', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ '%' ],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
          'label' => esc_html__( 'Full Content with space from?', 'Lawsight' ),
          'type'         => \Elementor\Controls_Manager::SELECT,
                'prefix_class' => 'pxl-full-content-with-space-',
                'options'      => array(
                    'none'    => esc_html__( 'None', 'Lawsight' ),
                    'start'   => esc_html__( 'Start', 'Lawsight' ),
                    'end'     => esc_html__( 'End', 'Lawsight' ),
                ),
                'default'      => 'none',
                'condition' => [
                    'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
                'label' => esc_html__('Container Width', 'Lawsight'),
...
function lawsight_add_custom_section_overlay_color( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_color',
        [
            'label' => esc_html__( 'Lawsight Overlay Color', 'Lawsight' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_color_offset',
        [
            'label'   => esc_html__( 'Overlay Color', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'Lawsight' ),
                'full'   => esc_html__( 'Full', 'Lawsight' ),
                'skew'   => esc_html__( 'Skew', 'Lawsight' ),
            ),
    ...
    $element->add_responsive_control(
        'overlay_left_space',
        [
            'label' => esc_html__('Overlay Left Space', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
    ...
    $element->add_responsive_control(
        'overlay_right_space',
        [
            'label' => esc_html__('Overlay Right Space', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px','%' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overlay Border Radius', 'Lawsight' ),
...
function lawsight_add_custom_section_overlay_img( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_img',
        [
            'label' => esc_html__( 'Lawsight Overlay Image', 'Lawsight' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_overlay_display',
        [
            'label'   => esc_html__( 'Overlay Image', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'Lawsight' ),
                'image'   => esc_html__( 'Yes', 'Lawsight' ),
            ),
    ...
    $element->add_control(
        'pxl_overlay_img',
        [
            'label'   => esc_html__( 'Select Image 1', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 1', 'Lawsight' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'Lawsight' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 1', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 1', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 1', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_control(
        'pxl_overlay_img2',
        [
            'label'   => esc_html__( 'Select Image 2', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
                'pxl_overlay_display' => ['image'],
            ],
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 2', 'Lawsight' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'Lawsight' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 2', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 2', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 2', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Offset Left - Image 2', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function lawsight_add_custom_section_divider( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_divider',
        [
            'label' => esc_html__( 'Lawsight Divider', 'Lawsight' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'row_divider',
        [
            'label'   => esc_html__( 'Divider', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''        => esc_html__( 'None', 'Lawsight' ),
                'rounded-top'   => esc_html__( 'Rounded Top', 'Lawsight' ),
                'angle-top'   => esc_html__( 'Angle Top Left', 'Lawsight' ),
                'angle-top-right'   => esc_html__( 'Angle Top Right', 'Lawsight' ),
                'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'Lawsight' ),
                'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'Lawsight' ),
                'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'Lawsight' ),
                'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'Lawsight' ),
                'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'Lawsight' ),
                'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'Lawsight' ),
                'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'Lawsight' ),
                'curved-top'   => esc_html__( 'Curved Top', 'Lawsight' ),
                'curved-bottom'   => esc_html__( 'Curved Bottom', 'Lawsight' ),
                'vertical1'   => esc_html__( 'Divider Vertical', 'Lawsight' ),
                'curved-arrow'   => esc_html__( 'Curved Arrow', 'Lawsight' ),
                'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'Lawsight' ),
                'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'Lawsight' ),
                'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'Lawsight' ),
            ),
    ...
    $element->add_control(
        'divider_color',
        [
            'label' => esc_html__('Divider Color', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_control(
        'divider_color_top',
        [
            'label' => esc_html__('Divider Color Top', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Divider Color Bottom', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_responsive_control(
        'divider_height',
        [
            'label' => esc_html__('Divider Height', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function lawsight_add_custom_section_particles( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_particles',
        [
            'label' => esc_html__( 'Lawsight Particles', 'Lawsight' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Particles', 'Lawsight' ),
    ...
    $element->add_control(
        'size_random',
        [
                'label' => esc_html__('Size Random', 'Lawsight'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'false',
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'move_direction',
        [
            'label'   => esc_html__( 'Move Direction', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'Lawsight' ),
                'top'        => esc_html__( 'Top', 'Lawsight' ),
...
function lawsight_add_custom_section_effect_image( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_effect_image',
        [
            'label' => esc_html__( 'Lawsight Effect Images', 'Lawsight' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $repeater_img->add_control(
        'image_position', 
        [
            'label' => esc_html__('Image Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'p-top-left' => 'Top Left',
    ...
    $repeater_img->add_control(
        'image_position_top', 
        [
            'label' => esc_html__('Top Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'image_position_left', 
        [
            'label' => esc_html__('Left Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Bottom Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Right Position', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'effect_image', 
        [
            'label' => esc_html__('Image Effect', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                '' => 'None',
                'pxl-image-spin' => 'Spin',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Type', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'y' => 'Effect Y',
                'x' => 'Effect X',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Value', 'Lawsight' ),
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Hover Value', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '40',
            'description' => esc_html__('Enter number.', 'Lawsight' ),
            'condition' => [
    ...
    $repeater_img->add_control(
        'image_display', 
        [
            'label' => esc_html__('Hide on Screen <= 1400px', 'Lawsight'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_md', 
        [
            'label' => esc_html__('Hide on Screen <= 1200px', 'Lawsight'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_sm', 
        [
            'label' => esc_html__('Hide on Screen <= 767px', 'Lawsight'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $element->add_control(
        'row_effect_images',
        [
            'label'   => esc_html__( 'Images', 'Lawsight' ),
            'type' => \Elementor\Controls_Manager::REPEATER,
...
/* Start Column */
add_action( 'elementor/element/column/layout/after_section_end', 'lawsight_add_custom_columns_controls' ); 
function lawsight_add_custom_columns_controls( \Elementor\Element_Base $element) {
    $element->start_controls_section(
        'columns_pxl',
        [
            'label' => esc_html__( 'Lawsight General Settings', 'Lawsight' ),
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__( 'Column Content Align', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__( 'Default', 'Lawsight' ),
                'start'           => esc_html__( 'Start', 'Lawsight' ),
                'center'           => esc_html__( 'Center', 'Lawsight' ),
                'end'           => esc_html__( 'End', 'Lawsight' ),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__( 'Column Sticky', 'Lawsight' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__( 'No', 'Lawsight' ),
                'sticky' => esc_html__( 'Yes', 'Lawsight' ),
            ),
            'default' => 'none',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Sticky Offset Top', 'Lawsight' ),
            'type' => 'text',
            'description' => esc_html__('Enter number.', 'Lawsight' ),
            'default'  => '30',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overflow Hidden', 'Lawsight'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__( 'Yes', 'Lawsight' ),
            'label_off' => esc_html__( 'No', 'Lawsight' ),
            'return_value' => 'yes',
            'default' => 'no',
            'separator' => 'after',
...
add_action( 'elementor/element/after_add_attributes', 'lawsight_custom_el_attributes', 10, 1 );
function lawsight_custom_el_attributes($el){
...
add_filter( 'pxl-custom-section/before-render', 'lawsight_custom_section_before_render', 10, 3 );
function lawsight_custom_section_before_render($html ,$settings, $el) {
...
add_filter( 'pxl-custom-column/before-render', 'lawsight_custom_column_before_render', 10, 3 );
function lawsight_custom_column_before_render($html, $settings, $el){
