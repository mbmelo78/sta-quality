...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('Case Nav Menu', 'Lawsight'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'Lawsight'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => $pxl_menus,
                        ),
                        array(
                            'name' => 'menu_type',
                            'label' => esc_html__('Menu Type', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'text_align',
                            'label' => esc_html__('Text Alignment', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__('Left', 'Lawsight' ),
                        ...
                        array(
                            'name' => 'max_height',
                            'label' => esc_html__('Max Height', 'Lawsight' ),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'Lawsight'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_active',
                            'label' => esc_html__('Color Active', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            'name' => 'menu_mega_type',
                            'label' => esc_html__('Menu Mega Type', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Menu Mega Border Radius', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px' ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Left', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Right', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Container Max Width', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Parent', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'none' => 'None',
                                'plus' => 'Plus',
                            ...
                            'default' => 'none',
                            'condition' => [
                                'hover_active_style' => ['fr-style-default','fr-spacer-divider','fr-horizontal-divider','fr-style-ha'],
                            ],
                        ),
                    ),
                ),
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'Lawsight'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top - Mega', 'Lawsight' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
