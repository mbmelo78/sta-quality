;(function ($) {
    ...
    $(window).on('load', function () {
        ...
        lawsight_header_mobile();
        lawsight_scroll_to_top();
        lawsight_footer_fixed();
        lawsight_shop_quantity();
        lawsight_submenu_responsive();
        lawsight_panel_anchor_toggle();
        lawsight_post_grid();
        lawsight_header_left_scroll();
    });
    ...
    $(window).on('scroll', function () {
        ...
        lawsight_scroll_to_top();
        lawsight_footer_fixed();
        lawsight_ptitle_scroll_opacity();
        lawsight_header_left_scroll();
    ...
    $(document).ready(function () {
        // lawsight_el_parallax();
        lawsight_backtotop_progess_bar();
        lawsight_type_file_upload();
        lawsight_zoom_point();
    ...
    /* Header Left Scroll */
    function lawsight_header_left_scroll() {
    ...
    /* Header Mobile */
    function lawsight_header_mobile() {
    ...
    /* Footer Fixed */
    function lawsight_footer_fixed() {
        setTimeout(function(){
    ...
    /* WooComerce Quantity */
    function lawsight_shop_quantity() {
        "use strict";
    ...
    function lawsight_submenu_responsive() {
        var $lawsight_menu = $('.pxl-header-elementor-main, .pxl-header-elementor-sticky');
        $lawsight_menu.find('.pxl-menu-primary li').each(function () {
            var $lawsight_submenu = $(this).find('> ul.sub-menu');
            if ($lawsight_submenu.length == 1) {
                if ( ($lawsight_submenu.offset().left + $lawsight_submenu.width() + 0 ) > $(window).width()) {
                    $lawsight_submenu.addClass('pxl-sub-reverse');
                }
            }
        });
    }

    function lawsight_panel_anchor_toggle(){
        'use strict';
    ...
    function lawsight_ptitle_scroll_opacity() {
    ...
    function lawsight_backtotop_progess_bar() {
    ...
    function lawsight_type_file_upload() {
    ...
    $('.pxl-icon-box1').each(function () {
        $(this).hover(function () {
            $(this).parents('.elementor-section').find('.pxl-icon-box1').removeClass('active');
