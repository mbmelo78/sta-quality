<?php 
$logo_m = Lawsight()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$logo_light_m = Lawsight()->get_opt( 'logo_light_m', ['url' => get_template_directory_uri().'/assets/img/logo-light.png', 'id' => '' ] );
$p_menu = Lawsight()->get_page_opt('p_menu');
$header_mobile = Lawsight()->get_page_opt('header_mobile', 'show');
$sticky_scroll = Lawsight()->get_opt('sticky_scroll');
...
$page_mobile_style = Lawsight()->get_page_opt('page_mobile_style');
$opt_mobile_style = Lawsight()->get_opt('opt_mobile_style');
$mobile_display = Lawsight()->get_opt('mobile_display');
if(isset($page_mobile_style) && !empty($page_mobile_style) && $page_mobile_style != 'inherit') {
    $opt_mobile_style = $page_mobile_style;
}
$header_mobile_layout = Lawsight()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)Lawsight()->get_opt('header_mobile_layout');
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php lawsight_header_mobile_search_form(); ?>
