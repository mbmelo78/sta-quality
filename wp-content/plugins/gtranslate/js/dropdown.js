(function(){
    ...
    if(horizontal_position != 'inline')
        widget_code = '<div class="gt_switcher_wrapper DROPDOWN" style="position:fixed;'+vertical_position+':15px;'+horizontal_position+':15px;z-index:999999;">' + widget_code + '</div>';
