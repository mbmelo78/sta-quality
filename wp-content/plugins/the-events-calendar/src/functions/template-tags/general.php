...
function tribe_events_promo_banner( $echo = true ) {
	if ( tribe_get_option( 'donate-link', false ) == true && ! tribe_is_bot() ) {
		...
		$html  = apply_filters( 'tribe_events_promo_banner', sprintf( '<p class="tribe-events-promo tribe-common-b1 tribe-events-c-promo" style="display:none">%s</p>', $promo ), $promo );
		if ( $echo ) {
			//echo $html;
		} else {
			//return $html;
